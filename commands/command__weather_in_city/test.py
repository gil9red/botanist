...
rs = requests.post('http://127.0.0.1:55003/execute', json=generate_request('Челябинск'))
print(rs.json())

rs = requests.post('http://127.0.0.1:55003/execute', json=generate_request('Москва'))
print(rs.json())
