...
# TODO: добавить команду получения случайного комикса http://comicsia.ru
#       https://gist.github.com/gil9red/5aa22cf4c880ce897eae5d60078b2008
...
# TODO: добавить команду картинку для добавления картинки через API https://www.flickr.com

# TODO: добавить команду хеширования: md5, sha1, и т.п.
...
# print(u.hex)
# print(str(u))
# Добавить возможность указывания флагов:
#   * -u вернуть в верхнем регистре
#   * -f вернуть с разделителями, т.е. форматированный
...
# TODO: добавить команду игры в крестики-нолики: https://ru.stackoverflow.com/questions/746752/
#       как вариант, можно показывать доску игры в текстовом виде либо рисовать на картинке

# TODO: добавить команду для случайной гифки
...
# TODO: добавить команду генерации пароля. Возможность настраивания количества символов и сложности пароля.
