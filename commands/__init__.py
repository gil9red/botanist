...
ALL_COMMAND_MODULE = [
    ...
    CommandModule(
        ...
        'Напиши кого бот отругает. Например (без кавычек): "Бот, ругнись петр иваныч"'
    ),
    CommandModule(
        'насмеши',
    ...
    CommandModule(
        ...
        'Погода в указанном населенном пункте. Например (без кавычек): "Бот, погода магнитогорск" '
